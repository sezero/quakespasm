...
cvar_t	sv_edgefriction = {"edgefriction", "2", CVAR_NONE, 0.0f, NULL, NULL, NULL};
...
cvar_t	sv_idealpitchscale = {"sv_idealpitchscale","0.8",CVAR_NONE, 0.0f, NULL, NULL, NULL};
cvar_t	sv_altnoclip = {"sv_altnoclip","1",CVAR_ARCHIVE, 0.0f, NULL, NULL, NULL}; //johnfitz
...
==============
*/
cvar_t	sv_maxspeed = {"sv_maxspeed", "320", CVAR_NOTIFY|CVAR_SERVERINFO, 0.0f, NULL, NULL, NULL};
cvar_t	sv_accelerate = {"sv_accelerate", "10", CVAR_NONE, 0.0f, NULL, NULL, NULL};
